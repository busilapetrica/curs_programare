...
Gigel a obţinut "numarOferte" oferte de preț și dorește să știe pentru fiecare dintre acestea dacă prețul este corespunzătar restricției pe care i-a impus-o tatăl său.
...
cele "raspuns" răspunsuri, în ordine: 1 dacă oferta este corespunzătoare restricției impuse și 0 în caz contrar.
...
int main(){
    int numarOferte, numarNorocos, raspuns;
    fin>>numarOferte;
